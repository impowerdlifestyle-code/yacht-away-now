...
// Update visible review count text
var links = document.querySelectorAll('a[href*="google"]');
links.forEach(function(a) {
if (a.textContent.match(/\d+\s*verified Google review/)) {
a.textContent = data.count + ' verified Google reviews';
}
});
// Update schema markup
var schemas = document.querySelectorAll('script[type="application/ld+json"]');
schemas.forEach(function(tag) {
try {
